...
Outpost `/ready` verifies access to its spool. Regional Collect availability does not make it unready: temporary regional loss is absorbed by the PVC and exposed through spool and delivery-failure metrics.
